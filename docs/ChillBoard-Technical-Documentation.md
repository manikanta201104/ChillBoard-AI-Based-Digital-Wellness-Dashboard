...
Live: https://chillboard.vercel.app/
...
- Admin moderation of reviews, users, challenges, and contact queries.
...
- Admin: Management endpoints for users, reviews, challenges, and contact queries (see Backend/routes/admin.js)
...
- SMTP/Nodemailer (legacy/testing): optional fallback (see README’s SMTP section); production prefers SES
...
- Pages in src/pages: Landing, Dashboard, Challenges, Profile, Settings, About, Privacy, AdminDashboard, ForgotPassword
...
## 6.1 Frontend Deployment (Vercel)
- Production domain: https://chillboard.vercel.app/
...
- Backend (Backend/.env):
  ...
  - Legacy/testing SMTP (optional): SMTP_HOST, SMTP_PORT, SMTP_SECURE, SMTP_USER, SMTP_PASS, SMTP_FROM
  - CORS/URLs: FRONTEND_URL, RENDER_URL (as applicable)
- Frontend (frontend/.env):
  - REACT_APP_BACKEND_URL, other public settings
- Extension (manifest.json/background.js): backend hosts in host_permissions; uses https://chillboard-6uoj.onrender.com and https://chillboard.vercel.app/
