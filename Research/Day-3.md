...
Date: June 04, 2025Project: ChillBoard – AI-Based Digital Wellness DashboardObjective: Build a Chrome extension to track screen time (time spent actively using Chrome) and store it locally, serving as the data source for ChillBoard’s wellness metrics.
Task Overview
...
Implemented Screen Time Tracking:
